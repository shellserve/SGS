...
def create_app(db_location):
    ...
    #We can add different sgs_api resources here passing an end/point and sometimes a get variable
   
    sgs_api = Api(app)
    sgs_api.add_resource(LoginResource, LOGIN_ENDPOINT)
    sgs_api.add_resource(LogoutResource, LOGOUT_ENDPOINT)
    sgs_api.add_resource(SignupResource, SIGNUP_ENDPOINT)
    sgs_api.add_resource(PlanResource, PLAN_ENDPOINT, f"{PLAN_ENDPOINT}/<id>")
    sgs_api.add_resource(ProjectResource, PROJECT_ENDPOINT, f"{PROJECT_ENDPOINT}/<id>")
    sgs_api.add_resource(ActionResource, ACTION_ENDPOINT)
    return app
